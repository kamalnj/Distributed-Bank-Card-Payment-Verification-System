    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8 text-center">
          <div className="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 text-xs font-semibold tracking-wide">
            PAIEMENT SÉCURISÉ
          </div>
          ...
          <p className="mt-2 text-gray-600">
            Remplissez les informations ci-dessous pour générer la demande de
            paiement
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <form
              onSubmit={onSubmit}
              className="rounded-3xl bg-white p-8 shadow-lg border border-gray-200"
            >
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className={`w-full border rounded-xl pl-11 pr-4 py-3 focus:outline-none focus:ring-2 ${
                        amountValid || montant === ""
